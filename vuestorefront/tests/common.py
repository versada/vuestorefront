...
class TestVuestorefrontCommon(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.Website = cls.env["website"]
        cls.ProductProduct = cls.env["product.product"]
        cls.ProductPublicCategory = cls.env["product.public.category"]
        ...
        cls.payment_acquirer_transfer = cls.env.ref("payment.payment_provider_transfer")
